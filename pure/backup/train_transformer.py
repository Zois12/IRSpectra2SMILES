...
from dataloader import IRDataset, collate_fn
...
MODEL_PATH = "checkpoints/best_transformer_model.pth"
CONFIG_PATH = "checkpoints/transformer_config.json"
TRAIN_RATIO = 0.8
VAL_RATIO = 0.1
SEED = 42
...
def train_model():
    ...
    for epoch in range(TRAIN_EPOCH):
        ...
        if val_loss < best_loss:
            ...
            tqdm.write(f"Saved best model to {MODEL_PATH}")
