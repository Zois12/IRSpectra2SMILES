...
def build_model(model_path: str, config: Dict, dataset_formula_dim: int, device: torch.device) -> SMILES2IRRegressor:
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate SMILES -> IR regressor.")
    ...
    print("=" * 70)
    print("SMILES->IR evaluation finished")
